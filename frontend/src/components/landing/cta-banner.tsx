...
export function CtaBanner() {
  return (
    <section className="px-4 py-16">
      <div className="mx-auto max-w-4xl rounded-3xl bg-gradient-to-r from-violet-600 via-fuchsia-600 to-indigo-600 p-8 text-center shadow-[0_20px_60px_rgba(124,58,237,0.35)] md:p-12">
