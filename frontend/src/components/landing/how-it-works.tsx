      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {HOW_IT_WORKS.map((item, i) => (
            ...
            >
              <div className="absolute -right-4 -top-4 h-20 w-20 rounded-full bg-cyan-500/10 blur-2xl transition group-hover:bg-emerald-500/10" />
              <span className="relative flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-500 to-emerald-500 text-sm font-bold text-white shadow-lg shadow-cyan-500/25">
                {item.step}
              </span>
